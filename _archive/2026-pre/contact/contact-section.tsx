...
// import { useAudioEngine } from '@/features/landing-page/spotify/use-audio-engine' // ARCHIVED - Tone.js removed
...
export function ContactSection() {
  ...
  // const { toneRef, startAudio, isLoaded } = useAudioEngine() // ARCHIVED - Tone.js removed
