...
const DetailWindow = ({
  ...
  >
    <m.div
      ...
      className="relative flex max-h-[85vh] w-[95vw] max-w-5xl flex-col overflow-hidden rounded-2xl border border-zinc-200/80 bg-white shadow-2xl dark:border-zinc-800 dark:bg-zinc-900"
    >
      {/* Clean Header */}
      <div className="flex items-center justify-between border-b border-zinc-100 px-6 py-4 dark:border-zinc-800">
        <div className="flex items-center gap-4">
          ...
          >
            {clip.type === 'bio' && <User className="h-5 w-5 text-blue-500" />}
            {clip.type === 'stats' && <Activity className="h-5 w-5 text-green-500" />}
            {clip.type === 'spotify' && <Music className="h-5 w-5 text-purple-500" />}
            {clip.type === 'stack' && <Layers className="h-5 w-5 text-amber-500" />}
          </div>
          <div>
            <h3 className="text-lg font-bold text-zinc-900 dark:text-white">
              {clip.name.toUpperCase().replace(/\.[^.]+$/, '')}
            </h3>
            {clip.subtitle && (
              <p className="text-xs text-zinc-500">{clip.subtitle}</p>
            )}
          </div>
        </div>
        <button
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      <span className="text-xs text-zinc-500">Jakarta Selatan, ID</span>
                    </div>
                  </div>
                </div>
                <div className="hidden items-center gap-2 sm:flex">
                  <span className="rounded-full bg-green-100 px-2.5 py-1 text-[10px] font-bold text-green-700 dark:bg-green-900/30 dark:text-green-400">
                    AVAILABLE
                  </span>
                </div>
              </div>
                ...
                <div className="lg:col-span-3 space-y-6">
                  ...
                  <div className="rounded-xl border border-zinc-100 bg-zinc-50/50 p-5 dark:border-zinc-800 dark:bg-zinc-900/50">
                    <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
                      Frontend Developer building performant, accessible, and delightful web
                      applications. Bridging the gap between engineering logic and creative
                      design — crafting interfaces that feel like instruments, not tools.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      ...
                      <div
                        key={k}
                        className="flex flex-col gap-1 rounded-xl border border-zinc-100 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900/50"
                      >
                      ...
                      {[
                        ...
                        <div key={i} className="flex gap-4">
                          <div className="flex flex-col items-center">
                            <div className="flex h-7 w-7 items-center justify-center rounded-full border border-zinc-300 bg-white text-[10px] font-bold dark:border-zinc-700 dark:bg-zinc-900">
                              {item.year.slice(2)}
                            </div>
                            {i < 2 && (
              ...
              <div className="mb-8 flex items-center justify-between border-b border-zinc-200 pb-4 dark:border-zinc-800">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-500">Performance Overview</p>
                  </div>
                </div>
                <div className="hidden items-center gap-2 sm:flex">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      <div
                        key={stat.label}
                        className="flex flex-col items-center rounded-xl border border-zinc-100 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900/50"
                      >
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      ...
                      <div
                        key={item.label}
                        className="flex flex-col rounded-xl border border-zinc-100 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900/50"
                      >
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        <div key={i} className="flex items-start gap-2">
                          <div className="mt-1.5 h-1 w-1 rounded-full bg-amber-400" />
                  ...
                  <div className="rounded-xl border border-zinc-100 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900/50">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {['Pixel Perfect', 'Accessible', 'Performant', 'Delightful'].map((tag) => (
                        <span
                          key={tag}
                          className="rounded-full border border-zinc-200 bg-zinc-50 px-2.5 py-1 text-[10px] font-bold text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-400"
                        >
                          {tag}
                        </span>
                      ))}
      ...
      clips: [
        {
          ...
          content: (
            <div className="flex h-full flex-col items-center justify-center">
              <div className="relative w-full rounded-xl bg-zinc-50 p-8 dark:bg-zinc-900/50">
                <div className="mb-6 flex items-center justify-center gap-3 text-purple-500">
                ...
                <div className="mt-8 border-t border-zinc-200 pt-6 text-center dark:border-zinc-800">
                  <p className="font-mono text-xs text-zinc-500">
                    "Music is the hidden arithmetic of the soul."
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="relative mx-auto max-w-6xl overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-2xl dark:border-zinc-800 dark:bg-zinc-950">
            ...
            <div className="flex items-center justify-between border-b border-zinc-200 bg-zinc-50 px-4 py-2 dark:border-zinc-800 dark:bg-zinc-900">
              <div className="flex items-center gap-4">
                ...
                <div className="hidden items-center gap-4 rounded bg-white px-3 py-1 font-mono text-xs text-green-700 md:flex dark:bg-zinc-950 dark:text-green-400">
                  <span>00:0{isPlaying ? Math.floor(Date.now() / 1000) % 10 : '0'}:00</span>
            ...
            <div className="flex h-8 items-center border-t border-zinc-200 bg-zinc-100 px-4 text-xs text-zinc-600 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-400">
              <span className="mr-2 font-bold text-blue-600 dark:text-blue-400">INFO</span>
              {hoveredClip
